...
export class DataTableComponent implements OnInit, OnDestroy {
  ...
  _onlyCre: boolean = true;
  // view chlid
  @ViewChild("checkBox") checkBox: MatCheckbox;
  // flex, force, standard
  @Input("columnMode") columnMode: string = "force";
  ...
  @Input()
  get onlyCre(): boolean {
    return this._onlyCre;
  }
  set onlyCre(value: boolean) {
    this._onlyCre = value;
    this.onlyUserChange.emit(this._onlyCre);
  }
