...
namespace VipcoMaintenance.Controllers
{
    ...
    public class RequisitionStockSpController : GenericController<RequisitionStockSp>
    {
        ...
        private IRepositoryMaintenance<SparePart> repositorySpare;
        ...
        {
            var HasItem = await this.repository.GetAsynvWithIncludes(key, "RequisitionStockSpId", new List<string> { "SparePart" });
            if (HasItem != null)
            {
