...
namespace VipcoMaintenance.Controllers
{
    ...
    {
        public WorkGroupMaintenanceController(IRepositoryMaintenance<WorkGroupMaintenance> repo):base(repo) { }
        ...
        public async Task<IActionResult> GetScroll([FromBody] ScrollViewModel Scroll)
        {
            ...
            return new JsonResult(new ScrollDataViewModel<WorkGroupMaintenance>(Scroll,
